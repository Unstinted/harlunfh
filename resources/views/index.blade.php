...
@section('content')
						...
						<div class="col-md-3 col-sm-12">
							<div class="heder-bottom-left">
								...
								<div class="header-logo">
									<a href="{{URL::to('index')}}"><img src="img/logo/logo.png" alt="logo"></a>
								</div>
							</div>
						</div>
						<div class="col-md-9 col-sm-12">
							<div class="header-bottom-right">
								...
								<div class="row">
									<div class="col-md-12">
										<!-- Main Menu Area -->
										<div class="main-menu-area another-home-mainmenu-area">
											<!-- Main Menu -->
											<div class="main-menu hidden-sm hidden-xs">
												<nav>
													@foreach($categories as $category)
													<ul class="main-ul">
														<li class="sub-menu-li"><a href="{{URL::to('index')}}" class="active">Home<i class="fa fa-home"></i></a></li>
														<li><a href="{{$category->id}}"><span class="label-menu">Sale</span>Women<i class="fa fa-chevron-down"></i></a>
		...
		<!-- Main Slider Area -->
		<div class="main-slider-area home-3-main-slaider-area entire-home-main-slider">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-sm-12">
						<!-- Main Slider -->
						<div class="main-slider">
							<div class="slider">
								<div id="mainSlider" class="nivoSlider slider-image">
									<img src="img/slider/africa-beauty.jpg" alt="main slider" title="#htmlcaption1"/>
									<img src="img/slider/Native-mix.jpg" alt="main slider" title="#htmlcaption3"/>
									<img src="img/slider/kids-slide.jpg" alt="main slider" title="#htmlcaption2"/>
									<img src="img/slider/combine.jpg" alt="main slider" title="#htmlcaption4"/>
								</div>
								<!-- Slider Caption One -->
								<div id="htmlcaption1" class="nivo-html-caption slider-caption-1">
									...
									<div class="slide-text">
										<div class="middle-text">
											<div class="cap-dec">
												<h1 class="cap-dec wow zoomInRight" data-wow-duration="1.1s" data-wow-delay="0s">Women Fashion</h1>
								...
								<div id="htmlcaption2" class="nivo-html-caption slider-caption-2">
									...
									<div class="slide-text slide-text-2">
										<div class="middle-text">
											<div class="cap-dec">
												<h1 class="wow zoomInUp" data-wow-duration="1.1s" data-wow-delay="0s">Kids Fashion</h1>
												<p class="wow zoomInUp" data-wow-duration="1.3s" data-wow-delay="0s"> up to 50% off Fashion collection Shop now</p>
											</div>	
								...
								<div id="htmlcaption3" class="nivo-html-caption slider-caption-1">
									...
									<div class="slide-text">
										<div class="middle-text">
											<div class="cap-dec">
												<h1 class="cap-dec wow zoomInRight" data-wow-duration="1.1s" data-wow-delay="0s">Men Fashion</h1>
												<p class="cap-dec wow zoomInRight" data-wow-duration="1.3s" data-wow-delay="0s"> up to 70% off Fahion collection Shop now</p>
											</div>
											<div class="cap-readmore wow zoomInRight" data-wow-duration=".9s" data-wow-delay=".5s">
												<a href="#">Shop Now</a>
						...
						<div class="main-slider-bottom-banner">
							<div class="row">
								<div class="col-md-6 col-sm-6 banner-add">
									<a href="#">
										<img alt="banner" src="img/banner/b11.png">
									</a>
								</div>
								<div class="col-md-6 col-sm-6 banner-add">
									<a href="#">
										<img alt="banner" src="img/banner/b12.png">
									</a>
								</div>
							</div>
					...
					<div class="col-md-4 col-sm-12">
						<div class="main-slider-banner-right">
							<div class="row">
								<div class="col-md-12 col-sm-6">
									<div class="slider-banner-right banner-add">
										<a href="#">
											<img alt="banner" src="img/banner/bar1.jpg">
										</a>
									</div>
								</div>
								<div class="col-md-12 col-sm-6">
									<div class="slider-banner-right right-slider-bottom-banner banner-add">
										<a href="#">
											<img alt="banner" src="img/banner/bar2.jpg">
										</a>
									</div>
								</div>
							</div>
						...
						<div class="col-md-4">
							...
							<div class="footer-left">
								...
								<div class="footer-logo">
									<a href="{{URL::to('index')}}"><img src="img/logo/logo-p.png" alt="logo"></a>
								</div>
								...
								<div class="information-link">
									<div class="single-information-link">
										...
										<ul>
											...
											<li><a href="{{URL::to('my-account')}}">Your Account</a></li>
